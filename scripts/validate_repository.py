...
REQUIRED = {
    ...
    "benchmark/adapters/claude_code/analytics/__init__.py",
    "benchmark/adapters/claude_code/analytics/aggregation.py",
    "benchmark/adapters/claude_code/analytics/classification.py",
    "benchmark/adapters/claude_code/analytics/enums.py",
    "benchmark/adapters/claude_code/analytics/loading.py",
    "benchmark/adapters/claude_code/analytics/models.py",
    "benchmark/adapters/claude_code/analytics/reporting.py",
    ...
    "docs/claude-multi-run-analytics.md",
    ...
    "tests/test_claude_adapter_analytics_aggregation.py",
    "tests/test_claude_adapter_analytics_classification.py",
    "tests/test_claude_adapter_analytics_cli.py",
    "tests/test_claude_adapter_analytics_loading.py",
    "tests/test_claude_adapter_analytics_models.py",
    "tests/test_claude_adapter_analytics_reporting.py",
    ...
    "tests/fixtures/claude_adapter_analytics/count-mismatch-run.json",
    "tests/fixtures/claude_adapter_analytics/degraded-run.json",
    "tests/fixtures/claude_adapter_analytics/different-case-set-run.json",
    "tests/fixtures/claude_adapter_analytics/unusable-return-code-run.json",
    "tests/fixtures/claude_adapter_analytics/usable-run.json",
    ...
    "scripts/analyze_claude_adapter_runs.py",
